...
import type { Province } from "@/app/type/Province"
        ...
        return (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => router.push(`/users/${beneficiaire.id}`)}>Modifier</DropdownMenuItem>
  ...
  return (
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Link href="/users/ajouter" passHref>
            <Button>
