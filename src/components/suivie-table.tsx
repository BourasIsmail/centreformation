...
import type { Suivie } from "@/app/type/Suivie"
  ...
  return (
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Link href={`/beneficiaire/${beneficiaireId}/suivie/ajouter`} passHref>
            <Button className="ml-auto">Ajouter un Suivi</Button>
          </Link>
        </CardHeader>
        <CardContent>
          {loading ? (
                  ...
                  <TableBody>
                    {suivieData.map((suivie) => (
                        <TableRow key={suivie.id}>
                          ...
                          <TableCell>{suivie.filiere?.specialite}</TableCell>
                          <TableCell>
                      <span
