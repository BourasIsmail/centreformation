...
CREATE TABLE `suivie` (
  ...
  `etat_de_formation` varchar(255) DEFAULT NULL,
  `observation` varchar(255) DEFAULT NULL,
  `benef_id` bigint DEFAULT NULL,
  `filiere_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKj46v5jqa9twf74cdatpa4gmj1` (`benef_id`),
  KEY `FKifx7qgjrma47g3wpw9tf3n5yf` (`filiere_id`),
  CONSTRAINT `FKifx7qgjrma47g3wpw9tf3n5yf` FOREIGN KEY (`filiere_id`) REFERENCES `filiere` (`id`),
  CONSTRAINT `FKj46v5jqa9twf74cdatpa4gmj1` FOREIGN KEY (`benef_id`) REFERENCES `beneficiaire` (`id`)
